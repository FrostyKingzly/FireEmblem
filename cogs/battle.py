...
FOREST_MOVEMENT_COST = 2
FOREST_DEFENSE_BONUS = 1
FOREST_AVOID_BONUS = 20
...
def calc_damage(attacker: Unit, defender: Unit) -> int:
    ...
    target_defense += terrain_defense_bonus(defender.coord)
...
def terrain_avoid_bonus(coord: str) -> int:
    return FOREST_AVOID_BONUS if terrain_at(coord) == TERRAIN_FOREST else 0


def terrain_defense_bonus(coord: str) -> int:
    return FOREST_DEFENSE_BONUS if terrain_at(coord) == TERRAIN_FOREST else 0


def terrain_movement_cost(coord: str) -> int:
    if terrain_at(coord) == TERRAIN_FOREST:
        return FOREST_MOVEMENT_COST
    return 1
